...
export class DashboardComponent implements OnInit {
  ...
  /**
   * Inicializa a API de gráficos com delay de 1s, o que permite a integração da API com o Angular.
   *
   * @return void
   */
   init(): void {
  ...
  /**
   * Cria e retorna o objeto DataTable da API de gráficos, reponsável por definir os dados do gráfico.
   *
   * @return any
   */
  obterDataTable(): any {
